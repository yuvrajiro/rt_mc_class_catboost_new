...
def run_training(
    ...
    catboost_train_dir_path: str = paths.OUTPUT_DIR,
) -> None:
    """
    ...
    try:
        ...
        #     transformed_train_inputs, transformed_train_targets , data_schema=data_schema
        # )
        balanced_train_inputs, balanced_train_targets = transformed_train_inputs, transformed_train_targets
        ...
        if run_tuning:
            ...
            # in default_hyperparameters add cat_features
            default_hyperparameters["cat_features"] = data_schema.categorical_features
            predictor = train_predictor_model(
                balanced_train_inputs, balanced_train_targets, default_hyperparameters
            ,catboost_train_dir_path)
