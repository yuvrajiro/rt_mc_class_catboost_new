...
,data_schema : MulticlassClassificationSchema) -> Tuple[pd.DataFrame, pd.Series]:
    """
    ...
    cat = data_schema.categorical_features
    smote = SMOTENC(k_neighbors=k_neighbors,categorical_features = cat, random_state=0)
